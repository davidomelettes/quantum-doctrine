...
return array(
    'view_manager' => array(
        'template_map' => array(
            ...
            'form/horizontal/element/checkbox'     => __DIR__ . '/../view/partial/form/horizontal/element/checkbox.phtml',
            'form/horizontal/element/date'         => __DIR__ . '/../view/partial/form/horizontal/element/date.phtml',
            'form/horizontal/element/datetime'     => __DIR__ . '/../view/partial/form/horizontal/element/datetime.phtml',
            'form/horizontal/element/select'       => __DIR__ . '/../view/partial/form/horizontal/element/select.phtml',
            'form/horizontal/element/submit'       => __DIR__ . '/../view/partial/form/horizontal/element/submit.phtml',
            'form/horizontal/element/text'         => __DIR__ . '/../view/partial/form/horizontal/element/text.phtml',
            'form/horizontal/element/textarea'     => __DIR__ . '/../view/partial/form/horizontal/element/textarea.phtml',
            'form/horizontal/element/time'         => __DIR__ . '/../view/partial/form/horizontal/element/time.phtml',
